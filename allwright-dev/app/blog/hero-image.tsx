...
function RoadmapHero({ variant }: { variant?: HeroVariant }) {
  return (
    <HeroFrame
      variant={variant}
      label="A release timeline: v0.0.7 at the start, a solid line traveled to today's v0.0.61 milestone marked 'you are here', then a dashed line ahead to v0.1.0 marked 'coming soon'. Two small chips labelled Web and Android hang off today's milestone, showing the small set of tangible features already real today."
    >
      <defs>
