...
const file_engine_v1_engine_proto_rawDesc = "" +
	...
	"\n" +
	"TabSession\x12&.allwright.engine.v1.TabSessionCommand\x1a$.allwright.engine.v1.TabSessionEvent(\x010\x01B#Z!allwright.dev/gen/allwright/engine/v1;enginev1b\x06proto3"
